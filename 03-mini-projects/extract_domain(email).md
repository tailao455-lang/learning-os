...
title: "[Mini Project] Data Cleaning Utils – Trích xuất domain từ email (phần sau @ cuối cùng)"
...
### Mục tiêu chính
- [x] Viết hàm extract_domain() Trích xuất domain từ email
...
### Features chính
- [x] extract_domain() – Trích xuất domain từ email
- [x] Kiểm tra email hợp lệ trước
- [x] Lấy phần sau @ cuối cùng
